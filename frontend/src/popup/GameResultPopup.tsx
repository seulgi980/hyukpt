...
import {type ApiError, type ApiResponse, type GameResult} from "../api/api"

export default function GameResultPopup({handleCloseButtonClick}: {
  ...
  const handleCaptureButtonClick = useCallback(() => {
    const captureElement: HTMLElement | null = document.querySelector('#game-result-capture-box');

    // 다운로드 기능을 별도 함수로 만듭니다.
    const downloadImage = (blob: Blob, filename = 'capture.png') => {
  ...
  }, [handleCloseButtonClick, handleCaptureButtonClick]);

  useEffect(() => {
    const fetchGameResult = async () => {
      try {
        const response = await fetch('api/team/match', { // 프록시 설정을 가정하고 상대 경로 사용
          method: 'POST',
          headers: {
        ...
        const data = (await response.json()) as ApiResponse<GameResult>;
  ...
  return (
    <div className="popup-wrapper">
      <div className="popup result">
        <div className="popup-title-box"/>
        {
          gameResult
            ...
            <div className="popup-body-box">
              <div id="game-result-capture-box">
                <div className="popup-body-box-player-result-box">
                  ...
                  <div className="popup-body-box-player-result-box-role-box">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="49" viewBox="0 0 48 49" fill="none">
                      <path d="M30.3158 30.6682L17.6842 30.6682L17.6842 17.8111L30.3158 17.8111L30.3158 30.6682Z"
                            fill="white"
                            fillOpacity="0.15"/>
                      <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="41" viewBox="0 0 48 41" fill="none">
                      ...
                      <path
                        ...
                        fill="currentColor"/>
                      <path
                        d="M23.8235 11.9285L16.5882 3.68292L18.1765 0.525024H29.8235L31.2353 3.68292L23.8235 11.9285Z"
                        fill="currentColor"/>
                      <path
        ...
        <div className="popup-footer result">
